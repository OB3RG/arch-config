...
pacman -S network-manager-applet dialog wpa_supplicant linux-headers avahi xdg-user-dirs xdg-utils gvfs gvfs-smb nfs-utils inetutils dnsutils bluez bluez-utils reflector acpi acpi_call flatpak 
